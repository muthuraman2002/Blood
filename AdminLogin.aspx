...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 100%; ">
        <tr>
            <td style="height: 63px; width: 336px;">
            </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 138px">
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="#990000" Text="Admin Login !"></asp:Label>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                ...
                <asp:Panel ID="Panel2" runat="server" Height="234px" Width="486px">
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="width: 249px; height: 40px;">
                                <asp:Button ID="Button1" runat="server" ForeColor="#CCFFFF" onclick="Button1_Click" 
                                        Text="Log In" Width="250px" CssClass="postButton" />
                            </td>
