<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="DonorDetails.aspx.cs" Inherits="DonorDetails" Title="Untitled Page" %>
        ...
        <table style="width: 100%; height: 505px;">
                        ...
                        <tr>
                            ...
                            <td style="width: 374px">
                                ...
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" 
                                    ForeColor="#990000" Text="All Donor Details!"></asp:Label>
                            </td>
                            <td>
                                &nbsp;</td>
                        </tr>
            ...
            <tr>
                ...
                <td style="height: 309px; width: 478px">
                    <asp:Panel ID="Panel2" runat="server" Height="520px" ScrollBars="Auto" 
                        Width="900px" BorderStyle="Ridge" BorderWidth="2px">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Photo">
                                    <ItemTemplate>
                                        <asp:Image ID="Image1" runat="server" Height="82px" Width="100px" 
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            <SelectParameters>
                                <asp:Parameter DefaultValue="Donor" Name="Role" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </asp:Panel>
                </td>
